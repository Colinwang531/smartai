...
int DigitCameraLivestream::open(const int userID /* = -1 */)
{
	...
	if (decoderPtr && scalerPtr && encoderPtr)
	{
		...
		helmetBGR24Queue.setCapacity(25);
		phoneBGR24Queue.setCapacity(12);
		sleepBGR24Queue.setCapacity(12);
		fightBGR24Queue.setCapacity(12);
		faceBGR24Queue.setCapacity(12);
